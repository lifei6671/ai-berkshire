...
description: 供应链瓶颈猎手。用于围绕 AI、能源、制造、医药等超级趋势拆解产业链瓶颈，筛选受益上市公司，并输出投资机会地图。
---
...
对 用户输入的研究对象/参数 超级趋势执行供应链瓶颈扫描与套利机会挖掘。
...
对每个确认的超级趋势执行类似拆解。使用网页搜索/浏览工具搜索：
...
搜索方式：
- 网页搜索/浏览工具 "{瓶颈环节} supplier listed company"
- 网页搜索/浏览工具 "{瓶颈环节} manufacturer stock"
- 网页搜索/浏览工具 "{瓶颈产品} market share company"
...
9. **遵循AGENTS.md 客观性原则** — 不预设看多，先数据后结论
