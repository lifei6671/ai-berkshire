---
name: earnings-team
description: 财报精读团队流程。用于并行拆解财报的生意本质、财务质量、竞争变化和风险信号，并生成研究报告或公众号文章。
---
...
对 用户输入的研究对象/参数 进行团队化财报精读分析。四位大师并行解读财报，编辑润色成文，读者评审把关质量，最终产出可直接发布的公众号文章。
...
- **阶段二·合成**：主代理 综合四个视角，产出研究报告初稿
- **阶段三·发布**：编辑 子代理 改写为公众号文章 + 读者评审 子代理 提出修改意见 → 主代理 定稿
...
将资料可得性评级告知每个 子代理，影响其分析深度。

### 第二步：向用户展示团队框架

| 阶段 | 角色 | 大师/定位 | 核心任务 |
|------|------|----------|---------|
| 研究 | **主代理**（你自己） | 总协调 | 统筹、合成、定稿 |
